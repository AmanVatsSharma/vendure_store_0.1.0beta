...
// NAMESPACE OBJECT: ./src/middleware.page.ts
var middleware_page_namespaceObject = {};
__webpack_require__.r(middleware_page_namespaceObject);
__webpack_require__.d(middleware_page_namespaceObject, {
  config: () => (config),
...
;// CONCATENATED MODULE: ./src/lib/consts.ts
...
const DEFAULT_CHANNEL_SLUG = "en";
const DEFAULT_LOCALE = "en";
const DEFAULT_NATIONAL_LOCALE = "en";
const channels = [
    {
        slug: DEFAULT_CHANNEL_SLUG,
        channel: DEFAULT_CHANNEL,
...
;// CONCATENATED MODULE: ./src/middleware.page.ts
...
function middleware(request) {
    ...
    if (regex.test(url.pathname)) {
        ...
        const response = NextResponse.redirect(new URL(replaced), {
            status: 308
        });
        if (channel === DEFAULT_CHANNEL_SLUG) {
            if (!locale || locale && locale?.length !== 2) {
                ...
                response.cookies.set("i18next", DEFAULT_LOCALE, {
                    path: "/"
                });
                return response;
            }
